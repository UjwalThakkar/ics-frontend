...
import { FileText, User, Mail, Phone, Upload, CheckCircle, Download } from 'lucide-react'
...
const ApplicationForm: React.FC<ApplicationFormProps> = ({ serviceType, onSubmit, onSave }) => {
  const [currentStep, setCurrentStep] = useState(1)
  const [submissionMethod, setSubmissionMethod] = useState<'online' | 'pdf'>('online')
    ...
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
      ...
      <div className="bg-gradient-to-r from-navy to-blue-700 text-white p-6 rounded-t-lg">
        <h1 className="text-2xl font-bold mb-2">
          {serviceType.replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase())} Application
        </h1>
        <p className="text-blue-100">Complete the form below to submit your application</p>
      </div>
            ...
            return (
              <div key={step.id} className="flex items-center">
                ...
                {index < steps.length - 1 && (
                  <div className={`hidden md:block w-full h-1 mx-4 ${
      ...
      <div className="p-6">
        ...
        {currentStep === 1 && (
          <div className="space-y-6">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Choose Submission Method</h2>
              ...
              >
                <div className="flex items-center mb-4">
                  <input
                    ...
                    className="mr-3"
                  />
                  <h3 className="text-lg font-medium text-gray-900">Online Submission</h3>
                </div>
              ...
              >
                <div className="flex items-center mb-4">
                  <input
                    ...
                    className="mr-3"
                  />
                  <h3 className="text-lg font-medium text-gray-900">Download PDF Form</h3>
                </div>
                <ul className="text-sm text-gray-600 space-y-2">
                  <li className="flex items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="text-sm space-y-1">
                    ...
                    <p><span className="font-medium">Service:</span> {serviceType.replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase())}</p>
                  </div>
                </div>
              </div>
            )}
